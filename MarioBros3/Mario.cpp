...
void CMario::KeyState(BYTE* state)
{
	...
	{
		Mariostate.movement = MoveStates::Walk;
		ax = 1;
	}
	...
	else if (CGame::GetInstance()->IsKeyDown(DIK_LEFT))
	{
		...
		Mariostate.movement = MoveStates::Crouch;
	else Mariostate.movement = MoveStates::Idle;
